...
export const TRIM_SIZE_DIMENSIONS = {
...
export class BaseProfile {
    constructor(id, displayName, defaultLayout) {
        this.id = id;
     ...
     */
    generateFrontmatterBlocks(book) {
        const blocks = [];
...
//# sourceMappingURL=base-profile.js.map