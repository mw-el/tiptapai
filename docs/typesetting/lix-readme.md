...
https://github.com/NicklasVraa/LiX/tree/master
...
If you are working locally, you need to have all package dependencies installed. This can be achieved by installing a full version of [TeX Live](https://www.tug.org/texlive/), or the *"basic-scheme"* and installing packages manually for a lean install.

Depending on which bundles are imported and what class is in use, LiX may import the following packages:

> [amsfonts](https://ctan.org/pkg/amsfonts), [amsmath](https://ctan.org/pkg/amsmath), [amssymb](https://ctan.org/pkg/amsfonts), [babel](https://ctan.org/pkg/babel), [caption](https://ctan.org/pkg/caption), [catchfile](https://ctan.org/pkg/catchfile), [ccicons](https://ctan.org/pkg/ccicons), [cite](https://ctan.org/pkg/cite), [csquotes](https://ctan.org/pkg/csquotes), [doclicense](https://ctan.org/pkg/doclicense), [ebgaramond](https://ctan.org/pkg/ebgaramond), [enumitem](https://ctan.org/pkg/enumitem), [esint](https://ctan.org/pkg/esint), [eso-pic](https://ctan.org/pkg/eso-pic), [fancyhdr](https://ctan.org/pkg/fancyhdr), [float](https://ctan.org/pkg/float), [fontaxes](https://ctan.org/pkg/fontaxes), [fontenc](https://ctan.org/pkg/fontenc), [geometry](https://ctan.org/pkg/geometry), [gothic](https://ctan.org/pkg/gothic), [graphicx](https://ctan.org/pkg/graphics), [GS1](https://ctan.org/pkg/gs1), [hyperref](https://ctan.org/pkg/hyperref), [ifmtarg](https://ctan.org/pkg/ifmtarg), [inconsolata](https://ctan.org/pkg/inconsolata), [inputenc](https://ctan.org/pkg/inputenc), [lastpage](https://ctan.org/pkg/lastpage), [lettrine](https://ctan.org/pkg/lettrine), [lipsum](https://ctan.org/pkg/lipsum), [listings](https://ctan.org/pkg/listings), [miama](https://ctan.org/pkg/miama), [microtype](https://ctan.org/pkg/microtype), [multicol](https://ctan.org/pkg/multicol), [mwe](https://ctan.org/pkg/mwe), [ninecolors](https://ctan.org/pkg/ninecolors), [numspell](https://ctan.org/pkg/numspell), [parskip](https://ctan.org/pkg/parskip), [pdflscape](https://ctan.org/pkg/pdflscape), [pdfpages](https://ctan.org/pkg/pdfpages), [pgfornaments](https://ctan.org/pkg/pgfornament), [pgf](https://ctan.org/pkg/pgf), [pgfopts](https://ctan.org/pkg/pgfopts), [setspace](https://ctan.org/pkg/setspace), [silence](https://ctan.org/pkg/silence), [siunitx](https://ctan.org/pkg/siunitx), [svg](https://ctan.org/pkg/svg), [tabularray](https://ctan.org/pkg/tabularray), [titlesec](https://ctan.org/pkg/titlesec), [titletoc](https://ctan.org/pkg/titletoc), [titling](https://ctan.org/pkg/titling), [tocbibind](https://ctan.org/pkg/tocbibind), [ulem](https://ctan.org/pkg/ulem), [upquote](https://ctan.org/pkg/upquote), [xcolor](https://ctan.org/pkg/xcolor), [xparse](https://ctan.org/pkg/xparse), [xifthen](https://ctan.org/pkg/xifthen), [xkeyval](https://ctan.org/pkg/xkeyval), [yfonts](https://ctan.org/pkg/yfonts)

The TeX Live basic scheme will require the following collections:
