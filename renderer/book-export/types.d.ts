...
export type Block = ParagraphBlock | HeadingBlock | ImageBlock | CodeBlock | MathBlock | BlockquoteBlock | TheoremBlock | DefinitionBlock | AlgorithmBlock | PoemBlock | HrBlock | PagebreakBlock;
